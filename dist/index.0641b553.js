...
async function fetchCountries() {
    try {
        const response = await (0, _axiosDefault.default).get("https://restcountries.com/v2/all"); // data ophalen van API
        ...
        console.log(response.data[0].population); proberen of het werkt*/ // de variablen te gebruiken methode te maken waar een functie in zit om de lijst te sorteren op population property
        countries.sort((a, b)=>{
